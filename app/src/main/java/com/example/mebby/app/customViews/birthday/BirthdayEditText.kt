...
class BirthdayEditText @JvmOverloads constructor(
    ...
    init {
        ...
        val birthdayTextWatcherCallback = object : BirthdayTextWatcherCallbacks {
            override fun onTextChanged(value: String, type: Birthday) {
                when (type) {
                    Birthday.Day -> {
        ...
        editTextDay.addTextChangedListener(BirthdayTextWatcher(type = Birthday.Day, callbacks = birthdayTextWatcherCallback))

        editTextMonth.addTextChangedListener(BirthdayTextWatcher(type = Birthday.Month, callbacks = birthdayTextWatcherCallback))

        editTextYear.addTextChangedListener(BirthdayTextWatcher(type = Birthday.Year, callbacks = birthdayTextWatcherCallback))
